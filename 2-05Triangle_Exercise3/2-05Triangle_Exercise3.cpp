// 2-05Triangle_Exercise3 : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
// 使用两个shader绘制两个不同的三角形
...
int main()
{
    ...
    // glfw: 创建窗口
    // ------------------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2-05Triangle_Exercise3", NULL, NULL);
    if (window == NULL)
    {
        printf("窗口创建失败");
