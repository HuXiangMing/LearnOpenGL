// 5-19Geometry_Shader_Normals : 此文件包含 "main" 函数。程序执行将在此处开始并结束。

/*
几何着色器
应用：通过几何着色器来修改原有的渲染方式，法向量可视化
...
int main()
{
	...
	// glfw: 创建窗口
	// ------------------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "5-19Geometry_Shader_Normals", NULL, NULL);
	if (window == NULL)
	{
		printf("窗口创建失败");
	...
	Shader normalShader("vertexSource.vert", "fragmentSource.frag", "geometrySource.geom");
