// 2-12Textures_Exercise2 : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
// 
...
int main()
{
	...
	// glfw: 创建窗口
	// ------------------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2-12Textures_Exercise2", NULL, NULL);
	if (window == NULL)
	{
		printf("窗口创建失败");
...
#pragma region 加载贴图
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);//线性过滤
