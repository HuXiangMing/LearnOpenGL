// 2-04Triangle_Exercise2 : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
// 使用两组顶点数据和两个不同VAOVBO进行绘制两个不同的三角形
...
int main()
{
    ...
    // glfw: 创建窗口
    // ------------------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2-04Triangle_Exercise2", NULL, NULL);
    if (window == NULL)
    {
        printf("窗口创建失败");
