// 2-18Coordinate_Systems_3D_Multiple : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
 
/* 
更多3D模型

注意在每次新立方体绘制出来的时候更新模型矩阵，如此总共重复10次。
...
int main()
{
	...
	// glfw: 创建窗口
	// ------------------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2-18Coordinate_Systems_3D_Multiple", NULL, NULL);
	if (window == NULL)
	{
		printf("窗口创建失败");
